...
<!DOCTYPE html>
  ...
  <body class="index-body">
   ...
   <div class="container">
      ...
      <div class="row mt15">
          <s:action name="wordVote!getWords"  var="p">
          <s:param value="projectId" name="projectId"></s:param>
          </s:action>
          <ul class="list-group">
          <s:iterator value="#p.votes" var="pv">
		        <li class="list-group-item p10"><s:property value="#pv.content"/><button class="btn bg p0 vote_upload" style="float:right;" data-id="<s:property value="#pv.vote.id"/>">支持（<s:property value="#pv.vote.poll"/>）</button></li>
		  </s:iterator> 
		  </ul>    
      </div>
   </div>
