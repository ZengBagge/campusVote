			            ...
			            <article class="form-group">
			             ...
			             <article class="form-group ">
			               <label for="maxNumber">最大投票量</label>
			                  <input name="maxNumber" value="1"  class="form-control" id="maxNumber" placeholder="最大可支持人数" check-type="number" required-message="必须为数字" type="number"/>
			            </article>
				          ...
				          info[2]=$("#organization").val();
				           info[3]=$("#contact").val();
				            info[4]=$("#beginDate").val();
				             ...
				             voteManage.addProject(info,model,maxNumber,function(result){
				               if(result[9]=="1"){
