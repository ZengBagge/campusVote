...
public class ImageUtils {
    ...
    public static void main(String[] args) {
        // 1-缩放图像：
        // 方法一：按比例缩放
        ImageUtils.scale("e:/abc.jpg", "jpg","e:/abc_scale.jpg", 2, true);//测试OK
        // 方法二：按高度和宽度缩放
        ImageUtils.scale2("e:/abc.jpg","jpg", "e:/abc_scale2.jpg", 500, 300, true);//测试OK
     ...
     */
    public final static void scale2(String srcImageFile, String type,String result, int height, int width, boolean bb) {
        try {
     ...
     * @param i //宽度
     */
	public static void scale2(String srcImageFile, String type, String result, int destWidth) {
		 try {
	            BufferedImage src = ImageIO.read(new File(srcImageFile)); // 读入文件
	            int width = src.getWidth(); // 得到源图宽
	            int height = src.getHeight(); // 得到源图长
	            if (width>destWidth) {// 图片宽度大于设定值
	            	double n = (double) destWidth/width;
	                width = destWidth;
	                height = (int) (height * n);
	            } 
	            Image image = src.getScaledInstance(width, height,
